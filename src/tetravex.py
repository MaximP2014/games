...
#
#
# Copyright (C) 2024 Maksim Petrenko
#
...
class MainWindow(tkinter.Tk):
    ...
    def play(self):
        ...
        # New board
        self.canvas.itemconfigure("tiles", state="normal")
        for (i, coords) in enumerate(L_BOARD, start=1):
    ...
    def move(self, event):
        ...
        if "tiles" in tags:
            ...
            # Outline
            self.canvas.create_rectangle(self.sel_tile["coords"],
        ...
        if self.sel_tile and self.sel_field:
            ...
            if len(board) == SIZE * SIZE:
                self.canvas.itemconfigure("tiles", state="disabled")
                # Message
