...
class MainWindow(tkinter.Tk):
    ...
    def __init__(self):
        ...
        # Window manager
        self.title("* Tetravex *")
        self.geometry("+{}+{}".format(self.winfo_screenwidth() // 2 - 356,
        ...
        self.style.configure("TButton", font=(FONT, 32, "bold"))
        # Widgets
        self.frame = ttk.Frame(self)
        self.frame.pack(padx=8, pady=8)
        # Canvas
        self.canvas = tkinter.Canvas(self.frame, width=693, height=324)
        self.canvas.pack()
        # Items
        # Fields 100x100
        ...
        self.canvas.create_rectangle((377, 4, 693, 320), fill=self.cget("bg"),
                                     tags=("message"))
        self.canvas.create_text(535, 54, text="\U0001F6C8",
        ...
        if self.sel_tile and self.sel_field:
            ...
            if self.canvas.bbox("tiles") == (3, 3, 321, 321):
                ...
                self.canvas.create_rectangle((377, 4, 693, 320),
                                             fill=self.cget("bg"),
                                             tags=("message"))
                self.canvas.create_text(535, 54, text="\U0001F3C6",
                                        font=(FONT, 64, "normal"),
                                        tags=("message"))
